# pages/2_Banco_de_Horas_Detalhadas.py (COM ORDEM DEPARTAMENTO/CARGO GARANTIDA)
...
# GARANTINDO A ORDEM: 'Departamento' antes de 'Cargo'
detalhes_positivo_df = detalhes_positivo_df[[
    'Matricula', 'Nome', 'Departamento', 'Cargo', 'Saldo Final (HH:MM)' 
]]
# RENOMEANDO PARA EXIBIÇÃO: 'Departamento' antes de 'Cargo'
